...
void ThreadTest4()
{
    ...
    int  numThreads = 8;
    int  NumOfLevel = 20;
    int  startTime[] = {13,  0, 20, 18,10 ,7,12,6};  //YOUR PROJECT2 CODE HERE: int  startTime[] = {13,  0, 20, 18,10 ,7,12,6};
    int  burstTime[] = { 23,  9, 7, 26, 5, 33 ,11 ,12 };
    int  priority[] = {  3,  3,   3,   3,  6 , 6,   6,  6 };  //YOUR PROJECT2 CODE HERE: int   priority[] = {  3,  3,   3,   3,  6 , 6,   6,  6 };
